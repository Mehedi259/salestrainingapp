...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/eyeclose.png
  AssetGenImage get eyeclose =>
      const AssetGenImage('assets/icons/eyeclose.png');

  /// File path: assets/icons/mail.png
  AssetGenImage get mail => const AssetGenImage('assets/icons/mail.png');

  /// List of all assets
  List<AssetGenImage> get values => [eyeclose, mail];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/backbutton.png
  AssetGenImage get backbutton =>
      const AssetGenImage('assets/images/backbutton.png');
  ...
  /// File path: assets/images/username.png
  AssetGenImage get username =>
      const AssetGenImage('assets/images/username.png');
